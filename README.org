...
brew install agzam/tap/mxp

# AUR (Arch Linux)
yay -S mxp

# Debian/Ubuntu
wget https://github.com/agzam/emacs-piper/releases/download/v0.4.0/mxp_0.4.0-1_all.deb
...
#+begin_src shell
curl -fsSL https://raw.githubusercontent.com/agzam/emacs-piper/main/mxp -o \
    ~/.local/bin/mxp \
    && chmod +x ~/.local/bin/mxp 
#+end_src

See [[file:INSTALL.md][INSTALL.md]] for detailed installation instructions for all platforms.
